...
const RULES: Rule[] = [
  ...
  { method: 'POST', pattern: /^\/work-orders\/(\d+)\/rollback$/, code: 'work_order_rollback', label: '撤回工单处理节点', area: '工单', objectType: 'work_order' },
  ...
  { method: 'POST', pattern: /^\/work-orders\/(\d+)\/void$/, code: 'work_order_void', label: '作废工单', area: '工单', objectType: 'work_order' },
  { method: 'DELETE', pattern: /^\/work-orders\/(\d+)$/, code: 'work_order_delete_permanent', label: '永久删除工单', area: '工单', objectType: 'work_order' },
